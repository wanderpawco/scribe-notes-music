    ...
    <div className="animate-fade-in space-y-4">
      ...
      <div className="rounded-2xl overflow-hidden mb-4 shadow-lg" style={{ background: '#0f0f1a', border: '1px solid rgba(200,169,110,0.3)' }}>
        ...
        <div className="flex items-center gap-2 px-5 py-3 flex-wrap" style={{ background: 'rgba(255,255,255,0.03)' }}>
          ...
          {/* New transcription — ghost button */}
          <button
            ...
            onMouseEnter={e => { (e.target as HTMLButtonElement).style.borderColor = 'rgba(255,255,255,0.3)'; (e.target as HTMLButtonElement).style.color = '#ffffff'; }}
            onMouseLeave={e => { (e.target as HTMLButtonElement).style.borderColor = 'rgba(255,255,255,0.15)'; (e.target as HTMLButtonElement).style.color = 'rgba(255,255,255,0.7)'; }}
          >
            <RefreshCw size={12} />
            New Transcription
          </button>
