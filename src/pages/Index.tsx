...
const features = [
  ...
  { icon: LinkIcon, title: "Paste a YouTube Link", desc: "No audio file? No problem. Paste any YouTube URL and ScribeNoter will extract the audio and transcribe it automatically. Perfect for transcribing performances and covers.", highlight: false },
